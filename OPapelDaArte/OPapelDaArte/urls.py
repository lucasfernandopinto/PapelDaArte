...
urlpatterns = [
    ...
    path('', views.index),
    path('Artistas/<art_nome>', views.artista),
    ...
    path('Publicações', views.noticias),
    path('Artigos', views.artigos),
    path('Entrevistas', views.entrevistas),
    path('Noticias/<id>', views.verNoticia),
    path('Artigos/<id>', views.verNoticia),
    path('Entrevistas/<id>', views.verNoticia),
